...
import {
  Search, X, Bot, Image as ImageIcon, Brain, Star, Loader2, AlertTriangle, RefreshCw,
} from 'lucide-react';
import {
  fetchModels, isFreeModel, formatMTokPrice, providerOf, supportsImageInput,
  supportsReasoning, formatContext, type OpenRouterModel,
...
const matchesFilter = (m: OpenRouterModel, mode: FilterMode): boolean => {
  switch (mode) {
    ...
    case 'reasoning': return supportsReasoning(m);
    case 'multimodal': return supportsImageInput(m);
  }
};
          ...
          >
            <div style={{ padding: 'var(--space-5) var(--space-6) var(--space-3)' }}>
              ...
              <div className="flex gap-1 wrap">
                ...
                >
                  <RefreshCw size={14} aria-hidden="true" className={loading ? 'spinner' : undefined} />
                </button>
              </div>
